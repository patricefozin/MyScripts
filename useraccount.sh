...
#########################################################################
new_generic_account () {
  ## this function will create an account and assign generic or random account information such as user id
  ## group id, directory, shell, etc
...
sleep 4
echo ""
read -p "Please enter the user account name: " account_name
echo ""
sleep 2
